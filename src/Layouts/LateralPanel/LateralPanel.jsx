...
import userIcon from '../../assets/images/ChatGPT_Image_26_may_2025__09_52_39_a.m.-removebg-preview.png';
...
export const LateralPanel = ({ onSelectSection }) => {
  const sections = [
    ...
    { title: 'Domicilios', bgColor: 'bg-[#d1b3ff]', icon: mietasIcon, key: 'domicilios' },
    { title: 'Reservas', bgColor: 'bg-[#7db7e2]', icon: reservaIcon, key: 'reservas', textColor: 'text-white' }
  ];

  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 p-4 sm:p-6 md:p-7 justify-items-center w-full">
