  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-transparent backdrop-blur-md px-4">
      <motion.div
        ...
        exit={{ opacity: 0 }}
        className="bg-white bg-opacity-90 rounded-2xl w-full max-w-lg shadow-2xl border border-pink-200 p-8"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-sm rounded-lg bg-pink-500 hover:bg-pink-600 text-white shadow-md"
            >
              Guardar cambios
            </button>
          </div>
