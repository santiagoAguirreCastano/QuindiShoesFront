...
export const NewProductForm = ({ onClose }) => {
  ...
  try {
    ...
    return (
        ...
        >
            <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-2xl mx-4 relative transition-all duration-300 ease-in-out">
                <button
                    onClick={onClose}
                ...
                >
                    {/* Select de tipo de producto o input personalizado */}
                        ...
                        {!mostrarInputTipo ? (
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-gray-300 hover:bg-gray-400 text-gray-700 px-3 rounded-md"
                                >
                                    Cancelar
                                </button>
                            </div>
                    ...
                    <AnimatePresence>
                        {mostrarNuevoColor && (
                            <motion.div
                                className="col-span-2 bg-gray-50 border rounded-md p-4 space-y-3 overflow-hidden origin-top"
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className="col-span-2 p-3 border rounded-md transition-all duration-300 focus:outline-pink-400"
                    />

                    <button
                        type="submit"
                        className="col-span-2 bg-pink-500 text-white py-3 rounded-md hover:bg-pink-600 transition"
                    >
                        Registrar Producto
                    </button>
                </form>
